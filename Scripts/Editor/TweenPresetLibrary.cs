...
{
    /// <summary>Creates the reusable preset assets used by the showcase and available to users.</summary>
    public static class TweenPresetLibrary
    {
        public const string Folder = "Assets/Plugins/UIMotionComposer/ScriptableObjects/Presets";
        ...
        [MenuItem("Tools/UI Motion Composer/Rebuild preset library")]
        public static void Build()
        {
            BuiltAssets.Clear();
            EnsureFolder("Assets/Plugins/UIMotionComposer", "ScriptableObjects");
            EnsureFolder("Assets/Plugins/UIMotionComposer/ScriptableObjects", "Presets");
            ...
            Debug.Log($"[UI Motion Composer] Rebuilt {AllPresetNames.Length} reusable preset assets in {Folder}.");
        }
