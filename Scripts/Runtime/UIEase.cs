...
namespace UIMotionComposer.Tweening
{
    ...
    ///
    /// Used by the runtime and inspector preview sampler. The formulas match the corresponding
    /// Penner/DOTween equations, including the default overshoot (1.70158) and period (0.3).
    /// </summary>
